...
Cross-cutting **limits** confirmed in Understand. They steer Scope. They are not epics or prototype / MVP / later scope, not stack choices, and not a list of product wishes. What should change on a path sits as **Wanted** on that [journey](journeys.md).
