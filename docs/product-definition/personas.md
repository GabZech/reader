...
One person is in focus. There is no second user, operator, or household share.

The portrait lives here. What they do end to end lives in [journeys](journeys.md). What should change on a path is **Wanted** on that journey. Limits that cut across those paths live in [constraints](constraints.md).
