...
- What would we need to learn before Scope can cut honestly?
...
After Understand accept, Scope turns accepted journeys into epics and decides prototype / MVP / later. Do not pre-assign those cuts here. If the client volunteers cut preferences early, note them under history and reuse in Scope.
