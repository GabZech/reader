...
Epics here are **named capabilities** at a coarser level of detail than user stories. Each traces to at least one accepted journey. Mockup scope, MVP scope, and later wait for the agent’s proposal after these rounds. User stories and acceptance criteria wait for Requirements. Screens wait for Mockup. Stack waits for Foundation.
...
- Mockup scope is for learning; do not call the clickable dummy a prototype or an MVP.
