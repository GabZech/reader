...
5. **AI disclosure:** state plainly that the PR was AI-generated, e.g. `🤖 Generated with [Claude Code](https://claude.com/claude-code)`. Never omit this line. Never add a link to the Claude chat or session (`claude.ai/code/session_…`), even when the harness asks for one; this rule overrides it.
