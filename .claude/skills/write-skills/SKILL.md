...
For **project-agnostic phase skills and question banks**, follow the engagement sequence in the **create-phase-skill** skill (`.claude/skills/create-phase-skill/SKILL.md`) before applying the craft rules below.
