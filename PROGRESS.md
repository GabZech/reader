...
1. List pages and a source's items page: both swipes, all four actions (two new routes: unread, unarchive), the popup, live tab counts — not started
2. Home rows: same swipes, next hidden row moves up — not started
